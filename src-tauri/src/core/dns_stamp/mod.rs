...
#![allow(dead_code, unused_imports, unused_variables, unused_mut, unreachable_pub, unreachable_code)]
...
pub use crate::core::dns_stamp::error::{DecodeError, DecodeResult, EncodeError, EncodeResult};
